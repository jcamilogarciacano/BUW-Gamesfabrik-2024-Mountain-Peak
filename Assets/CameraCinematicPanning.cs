...
public class CameraCinematicPanning : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        fadeSprite.color = new Color(0.15f, 0.15f, 0.15f, 1);
    ...
    void Update()
    {
        ...
        if (isPanning)
        {
            ...
            // Update fade color
            fadeSprite.color = Color.Lerp(new Color(0.15f, 0.15f, 0.15f, 1), new Color(1, 1, 1, 1), progress);
        }
    }
